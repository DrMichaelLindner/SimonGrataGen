...
% SimonGrataGen version: 0.98beta
%
...
uicontrol('Style','text', ...
    ...
    'String','Simon Grammar Task Generator by Michael Lindner and Doug Saddy, University of Reading',...
    'BackgroundColor',BackgroundColor);
    ...
    function menu_about_function(~,~)
        ...
        about_text={'',...
            ...
            '',...
            ['Version ',num2str(SGGver),' by Michael Lindner and Doug Saddy'],...
    ...
    function Simon_grammar_prepare()
        ...
        for subject=1:cfg.Nrsubjects
            ...
            for ngr=1:cfg.Nrgrammars
                ...
                cfg.Cutposgrammar(ngr)= ceil(Gcuts{ngr}(end)/dev(ngr));
